Subject: Contact Request: {$name} from {$instance}
            ...
            <tr>
                ...
                <td class="container">
                    <div class="content">
                        ...
                        <span class="preheader">{$name} just sent a message on the {$instance} instance.</span>
                            ...
                            <tr>
                                <td class="wrapper">
                                    ...
                                    <ul>
                                        ...
                                        <li><span class="bold">Request: </span>
                                            <div class="container align-center">{$request}</div>
                                        </li>
                                    </ul>
