Subject: New Account for {$realname} on {$study}
...
<head>
    ...
    <title>New Account on {$study}</title>
    ...
    <tr>
        ...
        <td class="container">
            <div class="content">
                ...
                <span class="preheader">New Account for {$realname} was created on the {$study} site.</span>
                <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="main">
                    ...
                    <tr>
                        <td class="wrapper">
                            ...
                            <p>Hello {$realname},</p>
                            <p>Your account on {$study} has been successfully created.</p>
                            {if !empty($password)}
