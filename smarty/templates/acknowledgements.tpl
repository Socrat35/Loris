...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
    ...
    <body>
        ...
        <div id="tabs">
            ...
            <h4>{if $authorship == "1"}For the Acknowledgements List, click <a href="{$baseurl}/acknowledgements/acknowledgements.php?date={$date}">here</a>.{else}For the Authorship List, click <a href="{$baseurl}/acknowledgements/acknowledgements.php?date={$date}&authors">here</a>.{/if}</h4>
